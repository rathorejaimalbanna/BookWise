  ...
  function googleLogin() {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        const data = { username: user.email, name: user.displayName };
        dispatch(userActions.addUser(data));
        navigate("/");
        // ...
      })
  ...
  return (
    <>
      ...
      <form
        ...
        onSubmit={data === "Sign Up" ? handleSignin : handleLogin}
      >
        ...
        >
          <span >
            <img src="./images/google.png" alt="Google Logo" className={styles.googleIcon}/>
          </span>
